...
#====================|3.3. Hybrid Model|====================
my_hybrid = cnn_with_lstm(my_dataset.X_train, my_dataset.y_train, my_dataset.X_val, my_dataset.y_val, my_dataset.X_test, my_dataset.y_test, my_dataset.max_length, embedding_dim = 100, vocab_size = my_dataset.vocab_size, num_classes = 3)
my_hybrid.train(epoch = 3, batch_size = 32)
my_hybrid.test()

# my_lstm_with_attention = lstm_with_attention(my_dataset.X_train, my_dataset.y_train, my_dataset.X_val, my_dataset.y_val, my_dataset.X_test, my_dataset.y_test, my_dataset.max_length, my_dataset.vocab_size, embedding_dim = 100, lstm_units = 64, dense_units = 32, num_classes = 3, dropout = 0.2)
